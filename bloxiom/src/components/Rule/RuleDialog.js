...
const RuleDialog = ({ showDialog, closeDialog, info }) => {
  ...
  return (
    ...
    >
          ...
          && (
            <div className={classes.container}>
              <Dropdown
                ...
                content={['Sign off needed', 'Locking account', 'Decline', 'Accept']}
      ...
      <DialogActions>
        <Button onClick={() => { setOpen(false); closeDialog(); }} color="secondary">
        Cancel
        </Button>
        <Button onClick={() => { updateGroupInd(''); closeDialog(); }} color="primary" disabled={!validEntry}>
        Save Rule
        </Button>
      </DialogActions>
    </Dialog>
